...
import {State, Voucher} from '../models';
...
export class VouchersController {
  ...
  async create(
    ...
    voucher: Omit<Voucher, 'voucher_id'>,
  ): Promise<Voucher> {
  ...
  async findState(
    @param.path.number('id') stateId : typeof State.prototype.id
  ): Promise<any> {
    return this.voucherRepository.state(stateId);
  }
}
